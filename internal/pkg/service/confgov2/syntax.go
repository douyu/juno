...
var (
	syntaxCheckers = map[model.ConfigFormat]syntaxChecker{
		model.ConfigFormatToml: tomlChecker,
		model.ConfigFormatYaml: yamlChecker,
		model.ConfigFormatIni:  iniChecker,
	}
)
