...
import (
	...
	"github.com/douyu/juno/pkg/handler/app"
	"github.com/douyu/juno/pkg/handler/static"
	"github.com/douyu/juno/pkg/invoker"
	"github.com/douyu/juno/pkg/middleware"
	"github.com/douyu/juno/pkg/packages/gitlab"
	"github.com/douyu/juno/pkg/packages/proxy"
	"github.com/douyu/juno/pkg/service"
	userSrv "github.com/douyu/juno/pkg/service/user"
	"github.com/douyu/juno/pkg/worker"
	"github.com/douyu/juno/router/apiv1/analysis"
	"github.com/douyu/juno/router/apiv1/confgo"
	"github.com/douyu/juno/router/apiv1/event"
	pprofHandle "github.com/douyu/juno/router/apiv1/pprof"
	"github.com/douyu/juno/router/apiv1/resource"
	"github.com/douyu/juno/router/apiv1/system"
...
func (eng *Admin) serveHTTP() {
	...
	{
		pprofGroup.POST("/run", pprofHandle.Run)                  // run
		pprofGroup.GET("/list", pprofHandle.FileList)             // list
		pprofGroup.GET("/checkDep", pprofHandle.CheckDep)         // CheckDep
		pprofGroup.GET("/installDep", pprofHandle.InstallDep)     // InstallDep
		pprofGroup.GET("/getSysConfig", pprofHandle.GetSysConfig) // GetSysConfig
		pprofGroup.GET("/setSysConfig", pprofHandle.SetSysConfig) // InstallDep
	}
