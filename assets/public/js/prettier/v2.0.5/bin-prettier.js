...
var stream$4 = _interopDefault(require('stream'));
...
var minimist_1 = function (args, options) {
  ...
  const newDefaults = Object.assign(Object.assign({}, defaults), fromPairs_1(booleanWithoutDefault.map(key => [key, PLACEHOLDER])));
...
var array_1 = array$1.flatten;
var array_2 = array$1.splitWhen;
...
picomatch.parse = (pattern, options) => {
  ...
  return parse_1$1(pattern, Object.assign(Object.assign({}, options), {}, {
    fastpaths: false
  }));
};
/**
...
var common_1 = common.isFatalError;
var common_2 = common.isAppliedFilter;
var common_3 = common.replacePathSegmentSeparator;
var common_4 = common.joinPathSegments;
...
var stream$1 = createCommonjsModule(function (module, exports) {
  ...
  class StreamProvider {
    constructor(_root, _settings) {
      ...
      this._settings = _settings;
      this._reader = new async$2.default(this._root, this._settings);
      this._stream = new stream$4.Readable({
        objectMode: true,
        read: () => {},
...
var stream$2 = createCommonjsModule(function (module, exports) {
  ...
  class ReaderStream extends reader$1.default {
    ...
    static(patterns, options) {
      ...
      const stream = new stream$4.PassThrough({
        objectMode: true
      });
...
var stream$3 = createCommonjsModule(function (module, exports) {
  ...
  class ProviderStream extends provider.default {
    ...
    read(task) {
      ...
      const destination = new stream$4.Readable({
        objectMode: true,
        read: () => {}
      });
...
function* expandPatterns(context) {
  ...
  for (const pathOrError of expandPatternsInternal(context)) {
    ...
    const relativePath = path.relative(cwd, pathOrError); // filter out duplicates
...
function run(args) {
  ...
  try {
    ...
    if (context.argv["support-info"]) {
      context.logger.log(src.format(jsonStableStringify(src.getSupportInfo()), {
        parser: "json"
      }));
      process.exit(0);
    }
