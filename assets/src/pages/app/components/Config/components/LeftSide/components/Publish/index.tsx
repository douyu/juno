      ...
      <div className={styles.optionBlock}>
        ...
        <div style={{ marginTop: '10px' }}>
          {checkedInstances.length === 0 && !switchPubK8S && (
            <OptionButton style={{ width: '100%' }} disabled>
              请先选择发布的实例
            </OptionButton>
          )}
          {(checkedInstances.length > 0 || switchPubK8S) && (
      ...
      <ScrollArea className={styles.instanceListScroll} smoothScrolling={true}>
        {configFile && k8sClusters && k8sClusters.length != 0 && (
          <ul className={styles.instanceList}>
            ...
            {k8sClusters
              .filter((item) => item.env.indexOf(env) > -1)
              .map((item: any, index: any) => {
                return (
                  ...
                  >
                    ...
                    <div className={styles.instanceStatus}></div>
                  </li>
                );
              })}
            {!configFile ||
              ...
              (k8sClusters.length == 0 && (
                <div className={styles.emptyTip}>应用在当前可用区环境下无集群</div>
              ))}
          </ul>
        )}
        {configFile && !configInstanceListLoading && configInstanceList && (
          <ul className={styles.instanceList}>
            <div className={styles.instanceListOpt}>
              ...
              <div style={{ textAlign: 'right' }}>
                {configInstanceList.length === checkedInstances.length &&
              ...
              return (
                ...
                >
                  <div className={styles.instanceInfo}>
                    ...
                    <div className={styles.instanceCheckBox}>
                      <Checkbox
                        onChange={onToggleInstanceCheck}
                        name={item.host_name}
                  ...
                  <div className={styles.instanceStatus}>
                    ...
                    {item.config_file_take_effect < 2 && (
                      <div
                        className={
                          item.config_file_take_effect
                            ? styles.statusSynced
                            : styles.statusNotSynced
                        }
                      >
            ...
            {configFile &&
              !configInstanceListLoading &&
              (!configInstanceList || configInstanceList.length == 0) && (
                <div className={styles.emptyTip}>应用在当前可用区环境下无实例</div>
              )}
          </ul>
        )}
      </ScrollArea>
