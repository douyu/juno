          ...
          >
            ...
            >
              ...
              <Form.Item
                label={'Header名称'}
                name={'header_name'}
                initialValue={grafanaConfig.header_name}
                rules={[{ required: true, message: '请填写Header名称' }]}
              >
                <Input
              ...
              <Form.Item
                ...
                rules={[
                  {
                    pattern: /^\/grafana\/[a-zA-Z0-9\.\/]{3,}$/,
                    message: '无效的监控面板地址，应该以 /grafana/ 开头',
                  },
                ]}
                initialValue={grafanaConfig.api_dashboard_addr}
              >
                <Input
                  placeholder={'API监控面板地址，比如：/grafana/d/api'}
                  disabled={!this.props.onEdit.grafana}
                />
              </Form.Item>
              <Form.Item
              ...
              >
                <Input
                  placeholder={'实例监控面板地址，比如：/grafana/d/instance'}
                  disabled={!this.props.onEdit.grafana}
                />
              </Form.Item>
              <Form.Item
              ...
              >
                <Input
                  placeholder={'概览监控面板地址，比如：/grafana/d/overview'}
                  disabled={!this.props.onEdit.grafana}
                />
              </Form.Item>
            </Form>
