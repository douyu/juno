...
function ModalAddEtcd(props) {
  ...
  return (
    <Modal title={'新增Etcd查询前缀配置'} {...props} width={600} onOk={() => form.submit()}>
      <Form form={form} labelCol={{ span: 5 }} onFinish={onFinish}>
        ...
        >
          <Input placeholder={'示例: /prometheus/job/'} />
        </Form.Item>
...
function ModalEditEtcd(props) {
  ...
  return (
    <Modal title={'修改Etcd查询前缀配置'} {...props} width={600} onOk={() => form.submit()}>
      <Form form={form} labelCol={{ span: 5 }} onFinish={onFinish}>
        <Form.Item
          label={'查询前缀'}
          name={'prefix'}
